    ...
    <>
      ...
      {open &&
        createPortal(
          ...
          >
            <div className="flex max-h-[88vh] w-full max-w-lg flex-col overflow-hidden bg-card shadow-2xl shadow-black/15 border-none rounded-2xl">
              <div className="flex items-center justify-between bg-[#2a1720] border-b border-white/10 px-6 py-3.5 text-white">
                <div className="flex items-center gap-2">
                  <RiCalendarLine className="size-5" fill="url(#icon-gradient)" aria-hidden />
                  <div>
                    <div id="quarter-select-modal-title" className="text-base font-semibold text-white">
                      {mt.title}
                    </div>
                    <div className="mt-0.5 text-xs text-white/70">{mt.hint}</div>
                  </div>
                </div>
                <button
                  type="button"
