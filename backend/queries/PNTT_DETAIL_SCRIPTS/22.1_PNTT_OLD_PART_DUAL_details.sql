-- =====================================================
-- PNTT_OLD_PART_DUAL_DETAILS - Old Patient - Partner Dual DETAIL
-- =====================================================
-- Disaggregated records for: Old partner dual + Test HIV + Positive
-- Logic matches `PNTT_OLD_PART_DUAL_aggregate.sql`
-- =====================================================
...
SELECT
    'PNTT_OLD_PART_DUAL' AS indicator_code,
