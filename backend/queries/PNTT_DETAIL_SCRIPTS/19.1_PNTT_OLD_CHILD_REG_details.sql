-- =====================================================
-- PNTT_OLD_CHILD_REG_DETAILS - Old Patient - Children Registered DETAIL
-- =====================================================
-- Disaggregated records for: Number of old children registered
-- Logic matches `PNTT_OLD_CHILD_REG_aggregate.sql`
-- =====================================================
...
SELECT
    'PNTT_OLD_CHILD_REG' AS indicator_code,
