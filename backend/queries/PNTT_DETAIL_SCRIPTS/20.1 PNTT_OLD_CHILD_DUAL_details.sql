-- =====================================================
-- PNTT_OLD_CHILD_DUAL_DETAILS - Old Patient - Child Dual DETAIL
-- =====================================================
-- Disaggregated records for: Old child dual + Test + Positive
-- Logic matches `PNTT_OLD_CHILD_DUAL_aggregate.sql`
-- =====================================================
...
SELECT
    'PNTT_OLD_CHILD_DUAL' AS indicator_code,
