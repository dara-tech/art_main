-- =====================================================
-- PNTT_OLD_PART_REF_DETAILS - Old Patient - Partner Referral DETAIL
-- =====================================================
-- Disaggregated records for: Old partner referral + Test HIV + Positive
-- Logic matches `PNTT_OLD_PART_REF_aggregate.sql`
-- =====================================================
...
SELECT
    'PNTT_OLD_PART_REF' AS indicator_code,
