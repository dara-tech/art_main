-- =====================================================
-- PNTT_OLD_CHILD_POS_REG_DETAILS - Old Patient - Child Positive and Register DETAIL
-- =====================================================
-- Disaggregated records for: Old child HIV positive and registered
-- Logic matches `PNTT_OLD_CHILD_POS_REG_aggregate.sql`
-- =====================================================
...
SELECT
    'PNTT_OLD_CHILD_POS_REG' AS indicator_code,
