-- =====================================================
-- PNTT_OLD_CHILD_CONT_DETAILS - Old Patient - Child Contact DETAIL
-- =====================================================
-- Disaggregated records for: Old child contact + Test + Positive
-- Logic matches `PNTT_OLD_CHILD_CONT_aggregate.sql`
-- =====================================================
...
SELECT
    'PNTT_OLD_CHILD_CONT' AS indicator_code,
