-- =====================================================
-- PNTT_OLD_CHILD_TEST_DETAILS - Old Patient - Child Tested DETAIL
-- =====================================================
-- Disaggregated records for: Old children who were tested for HIV
-- Logic matches `PNTT_OLD_CHILD_TEST_aggregate.sql`
-- =====================================================
...
SELECT
    'PNTT_OLD_CHILD_TEST' AS indicator_code,
