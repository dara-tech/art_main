-- =====================================================
-- PNTT_OLD_CHILD_POS_DETAILS - Old Patient - Child Tested Positive DETAIL
-- =====================================================
-- Disaggregated records for: Old children who were tested HIV positive
-- Logic matches `PNTT_OLD_CHILD_POS_aggregate.sql`
-- =====================================================
...
SELECT
    'PNTT_OLD_CHILD_POS' AS indicator_code,
