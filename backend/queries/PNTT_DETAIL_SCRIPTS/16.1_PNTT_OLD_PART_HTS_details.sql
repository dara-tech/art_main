-- =====================================================
-- PNTT_OLD_PART_HTS_DETAILS - Old Patient - Partner Tested by HTS DETAIL
-- =====================================================
-- Disaggregated records for: Partners who were tested for HIV by HTS
-- Logic matches `PNTT_OLD_PART_HTS_aggregate.sql`
-- =====================================================
...
SELECT
    'PNTT_OLD_PART_HTS' AS indicator_code,
