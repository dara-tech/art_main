-- =====================================================
-- PNTT_OLD_PART_CONT_DETAILS - Old Patient - Partner Contact DETAIL
-- =====================================================
-- Disaggregated records for: Old partner contact + Test HIV + Positive
-- Logic matches `PNTT_OLD_PART_CONT_aggregate.sql`
-- =====================================================
...
SELECT
    'PNTT_OLD_PART_CONT' AS indicator_code,
